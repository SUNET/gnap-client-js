...
import type { ContinueRequestAfterInteraction } from "../models/ContinueRequestAfterInteraction";
...
export class DefaultService {
  ...
  public static continueTransactionContinuePost(
    ...
    requestBody?: ContinueRequestAfterInteraction | null
  ): CancelablePromise<GrantResponse> {
    return __request(OpenAPI, {
      method: "POST",
      url: "/continue",
   ...
   * @throws ApiError
   */
  public static redirectInteractionRedirectTransactionIdGet(transactionId: string): CancelablePromise<string> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static authenticateSaml2SpAuthnTransactionIdGet(transactionId: string): CancelablePromise<string> {
    return __request(OpenAPI, {
      method: "GET",
